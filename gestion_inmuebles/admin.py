...
class CaracteristicasAdmin(admin.ModelAdmin):
    list_display = ('id', 'm2_construidos', 'm2_totales', 'estacionamientos', 'habitaciones', 'banos')
    list_editable = ('m2_construidos', 'm2_totales', 'estacionamientos', 'habitaciones', 'banos')  # Permite editar en línea
